...
subgraph "数据模型"
X[domain/skill.py<br/>领域模型]
Y[domain/workflow.py<br/>工作流领域模型]
Z[domain/notebook.py<br/>资产和源模型]
AA[api/models.py<br/>API模型]
end
A --> K
F --> K
I --> F
...
**图表来源**
- [frontend/src/lib/api/skills.ts](file://frontend/src/lib/api/skills.ts#L3-L53)
